...
<body>
	...
	<div>
		<h2>可选课程</h2>
		<form action="SelectClServlet" method="get">
			所有课程:<input type="radio" name="search" value="all">&nbsp;&nbsp;
			专业推荐:<input type="radio" name="search" value="recommend">
		...
		<form action="SelectClServlet" method="post">
			<table border="1">
				<tr align="center">
					<td>课程号</td><td>课程名</td><td>教师</td><td>学分</td><td>学时</td><td>教材</td><td>适应专业</td><td>选择</td>
				</tr>
				<%
